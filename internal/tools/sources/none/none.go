...
// It implements the Populater interface but all methods are no-ops.
type None struct{}
...
// Path is a no-op implementation of the Populater interface.
func (n *None) Path(_ string, _ []string, _ string, _ match.Requirements) error {
	return nil
}

// Install is a no-op implementation of the Populater interface.
