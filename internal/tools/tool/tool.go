...
type Tool struct {
	...
	Name string `yaml:"name"          mapstructure:"name"          single:"true" validate:"required"`
	// Description of the tool, giving more context about its purpose.
	Description string `yaml:"description"   mapstructure:"description"`
	// Version specifies the version of the tool.
	Version version.Version `yaml:"version"       mapstructure:"version"`
	...
	NoCache bool `yaml:"no-cache"      mapstructure:"no-cache"`
	// Inherit is used to determine which default configurations the tool should inherit from.
	Inherit *inherit.Inherit `yaml:"inherit"       mapstructure:"inherit"`
